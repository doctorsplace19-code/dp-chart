...
const REVIEWED_TITLE = 'Medical Director, WorkOccMed Medical Group, PLLC · FMCSA-Certified Medical Examiner';
...
<nav style="background:#0d1b2a;padding:0 40px;height:64px;display:flex;align-items:center;gap:32px;position:sticky;top:0;z-index:100;">
  <a href="/" style="display:flex;align-items:center;gap:12px;text-decoration:none;margin-right:8px;">
    ...
    <span style="display:flex;flex-direction:column;line-height:1.05;">
      ...
      <span style="font-size:11px;font-weight:500;color:#93c5fd;">a WorkOccMed Medical Group, PLLC company</span>
    </span>
  </a>
...
<footer style="background:#0d1b2a;color:#94a3b8;padding:40px 48px;text-align:center;">
  ...
  <div style="font-size:14px;color:#64748b;margin-bottom:16px;">A specialized division of WorkOccMed Medical Group, PLLC · New Jersey</div>
...
function articleSchema(g){
  const data = {
    ...
    "publisher": { "@type":"Organization", "name":"WorkOccMed", "parentOrganization":"WorkOccMed Medical Group, PLLC" },
